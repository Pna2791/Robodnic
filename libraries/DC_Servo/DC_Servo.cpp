...
Motor::Motor(unsigned aPin, unsigned bPin, unsigned dirPin, unsigned speedPin, unsigned resetPin)
    : encoderAPin(aPin), encoderBPin(bPin), dirPin_(dirPin), speedPin_(speedPin), resetPin_(resetPin), 
